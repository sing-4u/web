...
const Navbar: React.FC<NavbarProps> = ({ profileImage }) => {
  ...
  return (
    <div className="w-full border-b-[0.5px] border-inputBorderColor">
      <div className="flex justify-between items-center w-full h-[60px] md:h-[80px] max-w-[1440px] mx-auto px-6">
        <div
          onClick={() => navigate("/")}
