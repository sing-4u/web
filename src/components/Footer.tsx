...
const Footer = () => {
  return (
    <div className="w-full bg-white mobile:min-w-[375px] min-h-[40px] md:flex md:justify-center lg:w-full pc:w-[1440px] pc:h-[40px] pc:justify-between fixed bottom-0">
